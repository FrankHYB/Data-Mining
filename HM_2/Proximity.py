...
IrisFile = 'Iris_Test.csv'
IrisPreprocessed = 'Iris_Pre.csv'
iris_output_elud = 'Iris_output_elud.csv'
iris_output_cos = 'Iris_output_cos.csv'
header_iris = 'Transaction ID,1st,1-dist,2nd,2-dist,3rd,3-dist,4th,4-dist,5th,5-dist,class\n'
...
header_income = 'Transaction ID,1st,1-dist,2nd,2-dist,3rd,3-dist,4th,4-dist,5th,5-dist,class\n'
